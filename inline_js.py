# Script pour intégrer le JS directement dans article.html
import re
...
# Supprimer l'ancienne référence au script externe
content = content.replace('<script src="article-actions.js"></script>', '')

# Ajouter le script inline avant la fermeture du body
...
print("JS integre directement dans article.html!")
