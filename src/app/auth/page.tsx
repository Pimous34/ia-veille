...
const AuthPage = () => {
  ...
  const handleOAuthSignIn = async (provider: 'google' | 'apple' | 'twitter' | 'azure') => {
    try {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        ...
        <div className="p-8 text-center border-b border-gray-100 dark:border-gray-700">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Accédez à vore veille quotidienne personnalisée
          </p>
        </div>
        ...
        <div className="p-8">
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition-all"
            >
